...
export const setActivity = createAtomActivity<SetStep, BotWorkflowGlobalState>('set', {
  init: () => ({}),
  handler: async ({ properties }: SetStep, { $dynamics, $variables }: BotWorkflowGlobalState) => {
