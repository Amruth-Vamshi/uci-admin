...
export const httpRequestActivity = createAtomActivity<HttpRequestStep, BotWorkflowGlobalState>('httpRequest', {
  init: () => ({}),
  handler: async (step: HttpRequestStep, { $logger, $variables, $evaluator: $richText }: BotWorkflowGlobalState) => {
